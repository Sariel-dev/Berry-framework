...
local function NewMenuPool()
	...
	local function Process()
		...
		if (ContextMenuUseNui and not isKeyToggled and ContextMenuNuiClose) then
			ContextMenuNuiClose()
		end

		if (ContextMenuUseNui and not isKeyToggled and nuiFocusActive) then
		...
		if (isKeyToggled and isKeyToggledSinceLastTick) then
			...
			if (not ContextMenuUseNui and IsDisabledControlJustPressed(0, self.keys.keyboard.activateItem)) then
			...
			elseif (not ContextMenuUseNui and IsDisabledControlJustReleased(0, self.keys.keyboard.activateItem)) then
				for i = #self.menus, 1, -1 do
					if (self.menus[i]:Visible() and self.menus[i]:InBounds(cursorPosition)) then
			...
			if (not ContextMenuUseNui and IsDisabledControlJustPressed(0, 16)) then
				for i = #self.menus, 1, -1 do
			...
			elseif (not ContextMenuUseNui and IsDisabledControlJustPressed(0, 17)) then
				for i = #self.menus, 1, -1 do
					if (self.menus[i]:Visible() and self.menus[i].Scroll and self.menus[i]:InBounds(cursorPosition)) then
	...
	function self:Reset()
		...
		if (ContextMenuUseNui and ContextMenuNuiClose) then
			ContextMenuNuiClose()
		end
