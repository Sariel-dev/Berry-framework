...
if shared.networkdumpsters then
    local dumpsterHashSet = {}
    for _, hash in ipairs({218085040, 666561306, -58485588, -206690185, 1511880420, 682791951}) do
        dumpsterHashSet[hash] = true
    end
    
    CreateThread(function()
        while true do
            Wait(10000) -- Increased from 5000 to 10000ms
            ...
            for i = 1, objectCount do
                ...
                if state.isDumpster == nil then
                    ...
                    local isDumpster = dumpsterHashSet[model] or false
